...
As principais funcionalidades incluem:
  ...
  * **Manipulação de Objetos**: Permite a translação (teclas de seta para cima/baixo), rotação (teclas de seta para a esquerda/direita) e escala (teclas +/-) de objetos 3D através de eventos de teclado[cite: 5].
