...
## Melhorias Gerais
- [ ] Implementar tratamento de erros mais robusto para inicialização do SDL e OpenGL.
...
- [ ] Adicionar controles de câmera mais avançados (zoom, rotação livre).

## Performance
- [ ] Otimizar alocação e uso de buffers na GPU.
- [ ] Implementar renderização assíncrona.
